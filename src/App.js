...
export default function App() {
    return (_jsxs("div", { className: "min-h-screen", children: [_jsx(TopMenu, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/collaboration/*", element: _jsx(SectionPage, { section: "collaboration" }) }), _jsx(Route, { path: "/work/*", element: _jsx(SectionPage, { section: "work" }) }), _jsx(Route, { path: "/website/*", element: _jsx(SectionPage, { section: "website" }) }), _jsx(Route, { path: "/suite/:id", element: _jsx(SuiteProfile, {}) }), _jsx(Route, { path: "/protocol/:id", element: _jsx(ProtocolProfile, {}) }), _jsx(Route, { path: "/protocols/:id/versions/:version", element: _jsx(ProtocolVersionPage, {}) }), _jsx(Route, { path: "/needs/new", element: _jsx(NewNeedProfile, {}) }), _jsx(Route, { path: "/needs/:rootId", element: _jsx(NeedProfile, {}) }), _jsx(Route, { path: "/needs/:rootId/v/:version", element: _jsx(NeedVersionProfile, {}) }), _jsx(Route, { path: "/needs/:rootId/edit", element: _jsx(NeedEditorProfile, {}) }), _jsx(Route, { path: "/contributions", element: _jsx(ContributionsPage, {}) }), _jsx(Route, { path: "/explore", element: _jsx(ExploreProtocolsPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] })] }));
}
